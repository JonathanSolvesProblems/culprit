...
Source data: [TLC Trip Record Data](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page).
Field meanings, including that `VendorID = 7` is Helix and a real TLC code:
